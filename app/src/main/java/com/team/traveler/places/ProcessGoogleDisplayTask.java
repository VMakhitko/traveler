 ...
 */
public class ProcessGoogleDisplayTask extends AsyncTask<Object, Integer, List<HashMap<String, String>>> {
    ...
    protected List<HashMap<String, String>> doInBackground(Object... inObj) {
        ...
        try {
            ...
            googlePlacesList = placeJsonParser.parseGoogle(googlePlacesJSON);
